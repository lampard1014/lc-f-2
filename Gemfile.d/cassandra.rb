...
group :cassandra do
  gem "cassandra-cql", "1.2.3", git: "git@github.com:kreynolds/cassandra-cql.git",
    ...
    gem "thrift_client", "0.9.3", require: false, git: "git@github.com:twitter/thrift_client.git",
